...
def User(): #program user/kasir
    menu()
    pilih = str(input('Pilih Jenis Daftar Menu [Makanan/Minuman]: '))
    if pilih == 'Makanan' or pilih == 'makanan':
        makanan = DaftarMakanan[input('Nama makanan: ')]
        jumlah1 = int(input('Jumlah pesanan: '))
        Harga1 = jumlah1 * makanan
        print("Jumlah Harga Makanan: Rp. ", Harga1)
        Harga.append(Harga1)
        ...
        if pesan == 'Y' or pesan == 'y':
            ...
            print('Penulisan yang Anda masukkan salah\n')
    elif pilih == 'Minuman' or 'minuman':
        minuman = DaftarMinuman[input('Nama minuman: ')]
        jumlah2 = int(input('Jumlah pesanan: ')) 
        Harga2 = jumlah2 * minuman
        print("Jumlah Harga Minuman: Rp. ", Harga2)
        Harga.append(Harga2)
        pesan = str(input('Ingin pesan lagi? [Y/T]: '))
        if pesan == 'Y' or pesan == 'y':
            User()
...
>>> Silahkan Login :''')
    ...
    if pengguna == 'Admin' or pengguna == 'admin' and password == '063' :
        print('Admin: ',username)
        Admin()
    elif pengguna == 'User' or pengguna == 'user' and password == '210' :
        print('User: ',username)
        User()
        yes = True
        while yes == True:
        ...
        print('Maaf Password yang Anda masukkan tidak Valid!')